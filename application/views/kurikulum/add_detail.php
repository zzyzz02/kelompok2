      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <?php
              echo cmb_dinamis('kurikulum', 'kurikulum', 'nama_kurikulum', 'id_kurikulum', $this->uri->segment(3), "readonly='true'");
              ?>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <?php
              echo cmb_dinamis('mapel', 'mapel', 'nama_mapel', 'kd_mapel');
              ?>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <?php
              echo cmb_dinamis('jurusan', 'jurusan', 'nama_jurusan', 'kd_jurusan');
              ?>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <?php
              echo cmb_dinamis('tingkatan', 'tingkatan_kelas', 'nama_tingkatan', 'kd_tingkatan');
              ?>
            </div>
          </div>
