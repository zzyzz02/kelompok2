                ...
                <div class="box-body">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <td>Jurusan</td>
                            <td>
                                <?php echo cmb_dinamis('jurusan', 'jurusan', 'nama_jurusan', 'kd_jurusan', null, "id='filter_jurusan' onChange='loadData()'")
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?php echo cmb_dinamis('tingkatan_kelas', 'tingkatan_kelas', 'nama_tingkatan', 'kd_tingkatan', null, "id='filter_tingkatan' onChange='loadData()'")
                                ?>
                            </td>
                        </tr>
                        <tr>
