...
<head>
  ...
  <title>SMK Desa Suka Baca Buku</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <!-- Logo -->
      <a href="<?php echo base_url(); ?>tampilan_utama/" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>APL</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>APLIKASI PINTAR</b></span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url(); ?>uploads/user/<?php echo $this->session->userdata('foto'); ?> " class="user-image" alt="User Image">
                <span class="hidden-xs"><?php echo $this->session->userdata('nama_lengkap'); ?></span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="<?php echo base_url(); ?>uploads/user/<?php echo $this->session->userdata('foto'); ?>" class="img-circle" alt="User Image">
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2023 <a href="https://i.pinimg.com/236x/65/2b/f7/652bf71ab1e9f7abe55b3aca333e267b.jpg">SMK Suka Baca Buku</a>.</strong> All rights
      reserved.
    </footer>
