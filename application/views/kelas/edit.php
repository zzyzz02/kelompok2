      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <?php
              echo cmb_dinamis('tingkatan', 'tingkatan_kelas', 'nama_tingkatan', 'kd_tingkatan', $kelas['kd_tingkatan']);
              ?>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <?php
              echo cmb_dinamis('jurusan', 'jurusan', 'nama_jurusan', 'kd_jurusan', $kelas['kd_jurusan']);
              ?>
            </div>
          </div>
