                ...
                <div class="box-body">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <td>Jurusan</td>
                            <td>
                                <?php echo cmb_dinamis('jurusan', 'jurusan', 'nama_jurusan', 'kd_jurusan', null, "id='filter_jurusan' onChange='loadKelas()'")
                                ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo cmb_dinamis('tingkatan_kelas', 'tingkatan_kelas', 'nama_tingkatan', 'kd_tingkatan', null, "id='filter_tingkatan' onchange='loadKelas()'")
                                ?>
                            </td>
                        </tr>
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>
                            <?php
                            echo cmb_dinamis('kurikulum', 'kurikulum', 'nama_kurikulum', 'id_kurikulum');
                            ?>
                        </td>
                    </tr>
                    <tr>
