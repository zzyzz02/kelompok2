...
class Siswa extends CI_Controller
{
	...
	function edit()
	{
		if (isset($_POST['submit'])) {
			...
			$data['siswa'] = $this->db->get_where('siswa', array('nim' => $nim))->row_array();
	...
	function nilai_siswa()
	{
		...
		$sql 					= "SELECT ts.nama, tm.nama_mapel, tn.nilai
									  FROM nilai AS tn, jadwal AS tj, mapel AS tm, siswa AS ts
	...
	function aksi_naikkelas()
	{
		...
		//$querynaik = "UPDATE siswa SET kd_kelas = '8-A1' WHERE NIM = '18SI1000' AND kd_kelas = '$kelas'"
	}
