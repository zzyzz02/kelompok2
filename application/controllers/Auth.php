...
class Auth extends CI_Controller
{
	...
	function check_login()
	{
		if (isset($_POST['submit'])) {
			...
			// $loginUser untuk mengecek user pada user sedangkan $loginGuru memerika ke dalam guru
			...
			if (!empty($loginUser)) {
				...
				// $sessionGuru digunakan untuk mengkonversi data agar sesuai dengan data yang ada di user, sbg contoh di user ada nama_lengkap sedangkan di guru hanya ada nama_guru maka dari itu kita menmbuat 'nama_lengkap' yang mana datanya diambil dari $loginGuru['nama_guru']
				$sessionGuru = array(
